...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT_all(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,  KC_RALT, KC_APP,  KC_GRV, KC_LEFT, KC_DOWN, KC_RGHT
    ),

    LAYOUT_all(
        KC_SLEP,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,   KC_NO,   RESET,   KC_PSCR,
        ...
        _______, _______, _______, BL_DEC,  BL_INC,  BL_STEP, _______, _______, RGB_HUD, RGB_SAD, RGB_VAD, _______, _______, KC_VOLU, _______,
        _______, _______, _______, KC_MPLY, _______, _______, _______, KC_MRWD, KC_VOLD, KC_MFFD
    ),
};
